      ...
      <div className="row mx-lg-5 mx-4 my-md-3  my-4 py-4 " data-aos="fade-up">
        ...
        <div className="col-12 col-lg-8 col-md-7 order-2 order-md-1 ">
          <h5 className="bio text-responsive-center mx-auto">
            ...
            challenges and learning new skills through the use of code. I made
            my first real embark to the realm of programming in 2021, when I
            attempted to build my own fandom website for a show I liked, and
            ever since then I have been hooked on the idea of being a full-stack
            software developer. If you wish to speak to learn more about me and
            what I do, feel free to send me a message!
          </h5>
        </div>
