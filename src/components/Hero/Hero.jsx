        ...
        <div className="container-xl">
            <div className="row">
                <div className="col-lg-12 col-md-12">
                    <div className="mb-5 px-3 py-lg-5 mt-5">
                        <div className="row">
                            <div className="col-md-6">
                                <div class="text-responsive-center text-responsive-md-center">
                                    ...
                                    <h5 className="col-lg-12 mt-3 mt-md-5 desc text-responsive-center">A third-year Computer Science student and full stack developer based in British Columbia, Canada with 
                                    an eagerness to strengthen my knowledge in software development. 
                                        I create web applications with the sole intent of providing a pleasing digital experience for clients.</h5> 
                                    <div class="mt-lg-3">
                                    ...
                                    <div>
                                    <button type="button" class="btn btn-lg btn-primary px-5 mt-4 btn-purple-gradient">Resume</button>
                                    </div>
                                    </div>
                                </div>
                            </div>
